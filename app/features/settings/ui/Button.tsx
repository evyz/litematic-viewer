...
export default function SettingsButton({ modalType, setModalType }: Props) {
    return (
        <Button variant={"outline"} className={"size-10 rounded-full"} onClick={() => setModalType(prev => prev !== null ? null : 'settings')}>
            {modalType === "settings" ? <ActiveIcon /> : <Icon />}
        </Button>
    )
}
