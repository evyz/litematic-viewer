...
export default function ScreenCameraState({ world }: Props) {

    const clickHandler = () => {
        console.log(world.getCameraState());
    }

    return (
        <Button variant={"outline"} className={"size-10 rounded-full"} onClick={clickHandler}>
            <Icon />
        </Button>
    )
}
